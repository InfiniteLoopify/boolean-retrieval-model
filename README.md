...
<!-- TODO: REPLACE ALL `boolean-retrieval-model`, `Boolean Retrieval Model`, `Boolean and Proximity query processing using Inverted Index and Positional Index`. FILL "about the project" and uncomment hidden sections if needed -->
<a name="readme-top"></a>
...
<br />
<div align="center">
  <!-- <a href="https://github.com/InfiniteLoopify/boolean-retrieval-model">
    <img src="images/logo.png" alt="Logo" width="80" height="80">
  </a> -->
<h3 align="center">Boolean Retrieval Model</h3>

  <p align="center">
    Boolean and Proximity query processing using Inverted Index and Positional Index
    <br />
    <a href="https://github.com/InfiniteLoopify/boolean-retrieval-model"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <!-- <a href="https://github.com/InfiniteLoopify/boolean-retrieval-model">View Demo</a>
    · -->
    <a href="https://github.com/InfiniteLoopify/boolean-retrieval-model/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/InfiniteLoopify/boolean-retrieval-model/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
Boolean and Proximity query processing using Inverted Index and Positional Index for more than 50 political speeches in the United States.

![Screenshot](images/screenshot.png)
*the documents in which the word 'republic' is commonly occuring*
...
2. Clone the repository:
    ```bash
    git clone https://github.com/InfiniteLoopify/boolean-retrieval-model.git
    ```
...
See the [open issues](https://github.com/InfiniteLoopify/boolean-retrieval-model/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/InfiniteLoopify/boolean-retrieval-model](https://github.com/InfiniteLoopify/boolean-retrieval-model)
...
[contributors-shield]: https://img.shields.io/github/contributors/InfiniteLoopify/boolean-retrieval-model.svg?style=for-the-badge
[contributors-url]: https://github.com/InfiniteLoopify/boolean-retrieval-model/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/InfiniteLoopify/boolean-retrieval-model.svg?style=for-the-badge
[forks-url]: https://github.com/InfiniteLoopify/boolean-retrieval-model/network/members
[stars-shield]: https://img.shields.io/github/stars/InfiniteLoopify/boolean-retrieval-model.svg?style=for-the-badge
[stars-url]: https://github.com/InfiniteLoopify/boolean-retrieval-model/stargazers
[issues-shield]: https://img.shields.io/github/issues/InfiniteLoopify/boolean-retrieval-model.svg?style=for-the-badge
[issues-url]: https://github.com/InfiniteLoopify/boolean-retrieval-model/issues
[license-shield]: https://img.shields.io/github/license/InfiniteLoopify/boolean-retrieval-model.svg?style=for-the-badge
[license-url]: https://github.com/InfiniteLoopify/boolean-retrieval-model/blob/master/LICENSE
